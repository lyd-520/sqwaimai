package com.roy.sqwaimai.generator;
...
public class Generator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String module = "test";
        String basePackageName = "com.roy.sqwaimai";
        String controllerPackageName = "app.controller."+module;
        ...
        options.addOption("p", "package", true, "base package name,default:com.roy.sqwaimai");
