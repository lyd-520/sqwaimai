<template>
    <section id='foot_guide'>
        ...
        <section @click = "gotoAddress('/orderDetail')" class="guide_item">
        	<svg class="icon_style">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('orderDetail') !== -1? '#orderActive' : '#order'"></use>
            </svg>
            <span>送单</span>
        </section>

        <!-- <section @click = "gotoAddress({path: '/order/orderDetail', query: {geohash}})" class="guide_item">
        	<svg class="icon_style">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('msite') !== -1? '#msiteActive' : '#msite'"></use>
            </svg>
            <span>送单</span>
        </section> -->
        <section @click = "gotoAddress({path: `/balance`})" class="guide_item">
        	<svg class="icon_style">
