...
import com.roy.sqwaimai.bean.entity.front.Admin;
import com.roy.sqwaimai.bean.entity.front.Ids;
import com.roy.sqwaimai.bean.vo.business.CityInfo;
import com.roy.sqwaimai.bean.vo.business.Constants;
...
public class AdminController extends BaseController {
    ...
    public Object login(HttpServletRequest request) {
        ...
        String newPwd = MD5.getMD5String(MD5.getMD5String(password).substring(2,7)+ MD5.getMD5String(password));
        if(result!=null){
